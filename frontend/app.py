...
if user_input:
    ...
    # 2) “Yes” intercept to keep button alive
    ...
    # 3) Direct time‐pick intercept (exact ISO match)
    ...
    # 4) Ordinal‐pick intercept (“first”, “second”, etc.)
    ...
    # 5) Fallback to your /chat endpoint with history
    else:
        ...
        # Cache any returned raw slots array
...
if st.session_state.proposed_time:
    ...
    if st.button("✅ Yes, book this meeting"):
        ...
        if booking.status_code == 200:
            ...
            # Clear for the next booking cycle
            st.session_state.proposed_time = None
            st.session_state.last_slots = []
        else:
